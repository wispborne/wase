...
class _$VariantCopyWithImpl<$Res> implements $VariantCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? hullId = freezed,
    Object? variantId = freezed,
    Object? fluxVents = freezed,
    Object? fluxCapacitors = freezed,
    Object? hullMods = freezed,
    Object? weaponGroups = freezed,
    Object? goalVariant = freezed,
    Object? quality = freezed,
    Object? permaMods = freezed,
...
class _$_Variant implements _Variant {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.hullId, hullId) &&
            const DeepCollectionEquality().equals(other.variantId, variantId) &&
            const DeepCollectionEquality().equals(other.fluxVents, fluxVents) &&
            const DeepCollectionEquality()
                .equals(other.fluxCapacitors, fluxCapacitors) &&
            const DeepCollectionEquality().equals(other._hullMods, _hullMods) &&
            const DeepCollectionEquality()
                .equals(other._weaponGroups, _weaponGroups) &&
            const DeepCollectionEquality()
                .equals(other.goalVariant, goalVariant) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(hullId),
      const DeepCollectionEquality().hash(variantId),
      const DeepCollectionEquality().hash(fluxVents),
      const DeepCollectionEquality().hash(fluxCapacitors),
      const DeepCollectionEquality().hash(_hullMods),
      const DeepCollectionEquality().hash(_weaponGroups),
      const DeepCollectionEquality().hash(goalVariant),
